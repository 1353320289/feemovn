...
sh_ver="100.0.2.8"
github="raw.githubusercontent.com/1353320289/feemovn/refs/heads/main"
...
start_menu() {
  clear
  echo && echo -e " ${Green_font_prefix} FEEMO--方生  集合加速 ${Font_color_suffix}
  echo && echo -e " ${Red_font_prefix}Feemo提醒 注意--不同组合有不同效果,谨慎使用!!! ${Font_color_suffix}
