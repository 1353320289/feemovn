...
start_menu() {
  ...
  ********************************************************************************************
   echo -e "${Green_font_prefix} 维护:fll ${Green_font_prefix} ${Red_font_prefix}[v${sh_ver}] 保护内核${Font_color_suffix}
   echo -e "${Green_font_prefix} 作者:fll ${Green_font_prefix} ${Red_font_prefix}[v${sh_ver}] 保护内核${Font_color_suffix}
